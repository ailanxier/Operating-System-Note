...
+ 操作系统的内核构成：
  ...
  > 注意选择题中「执行」和「发生」的区别。
  >
  > ![image-20211210220654769](./Operating System.assets/image-20211210220654769.png)
  >
  > ![image-20211210224855348](./Operating System.assets/image-20211210224855348.png)
...
+ 操作系统的内核的内容：
  ...
  + **时钟管理**：
    ...
    >
    >   ![image-20211210232945020](./Operating System.assets/image-20211210232945020.png)
...
+ 中断处理过程：
  ...
  >
  >​	![image-20211210233357503](./Operating System.assets/image-20211210233357503.png)
...
+ 写时复制：
  ...
  + 然而，只要有一个进程试图写私有区域内的某个页面，那么这个写操作就会触发一个**保护故障**：
    ...
    ![image-20211206210446323](./Operating System.assets/image-20211206210446323.png)
...
+ 中断驱动方式：
  ...
  ![image-20211206221411112](./Operating System.assets/image-20211206221411112.png)
